import{t as ve,s as ge,b as be,m as ye,e as Ce,j as Se,n as De,k as we,o as xe,B as $e,_ as Le,a5 as qe,a1 as ke,a6 as Ee}from"./UserMenu-Ci2Q-fRV.js";import{g as Re,s as Ie}from"./authSession-C_6MfiSh.js";const pe=[{value:"open",label:"Open"},{value:"in-progress",label:"In progress"},{value:"require-clarification",label:"Needs clarification"},{value:"testing",label:"Testing"},{value:"tested",label:"Tested"},{value:"resolved",label:"Resolved"},{value:"duplicate",label:"Duplicate"},{value:"wont-fix",label:"Won't fix"}],Ae=()=>`
