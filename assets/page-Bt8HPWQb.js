import{u as ve,t as ge,b as be,m as ye,e as Ce,k as Se,o as De,n as we,p as xe,i as $e,$ as Le,a6 as qe,a2 as ke,a7 as Ee}from"./UserMenu-Ba2ahWxX.js";import{g as Re,s as Ie}from"./authSession-Dsc4BFUS.js";const pe=[{value:"open",label:"Open"},{value:"in-progress",label:"In progress"},{value:"require-clarification",label:"Needs clarification"},{value:"testing",label:"Testing"},{value:"tested",label:"Tested"},{value:"resolved",label:"Resolved"},{value:"duplicate",label:"Duplicate"},{value:"wont-fix",label:"Won't fix"}],Ae=()=>`
