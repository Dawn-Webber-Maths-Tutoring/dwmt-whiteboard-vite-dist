import{u as ye,t as be,b as Ce,m as Se,e as $e,k as we,o as De,n as xe,p as qe,i as Ee,a0 as Le,a7 as ke,a3 as Re,a8 as de,a9 as Ae}from"./UserMenu-Dr4mai6A.js";import{g as Ie,s as Be}from"./authSession-N-TcGMyx.js";const fe=[{value:"open",label:"Open"},{value:"in-progress",label:"In progress"},{value:"require-clarification",label:"Needs clarification"},{value:"testing",label:"Testing"},{value:"tested",label:"Tested"},{value:"resolved",label:"Resolved"},{value:"duplicate",label:"Duplicate"},{value:"wont-fix",label:"Won't fix"}],Fe=()=>`
