import{o as M,p as E,b as I,m as R,e as H,i as N,k as U,j as D,l as j,a2 as O,a3 as G}from"./UserMenu-DRNttFAF.js";import{c as J}from"./studentPicker--1eQP9lv.js";import{g as V,s as z}from"./authSession-LjQdVIWY.js";const W=()=>{try{const t=localStorage.getItem("dwmt-selected-student");if(!t)return[];const e=JSON.parse(t);if(Array.isArray(e))return e.filter(r=>r&&r.username&&r.email)}catch(t){console.warn("Failed to load selected students for activity filter",t)}return[]},_=t=>{try{if(t.length>0){localStorage.setItem("dwmt-selected-student",JSON.stringify(t));return}localStorage.removeItem("dwmt-selected-student")}catch(e){console.warn("Failed to save selected students for activity filter",e)}},F=(t,e,r)=>{const a=t.querySelector("#studentAvatarGroup");if(!a)return;if(e!=="tutor"||r.length===0){a.hidden=!0,a.innerHTML="";return}const s=document.createDocumentFragment();r.forEach(o=>{const n=document.createElement("button");n.type="button",n.className="student-avatar";const d=o.avatarUrl||"/default_avatar.png";n.innerHTML=`<img src="${d}" alt="" aria-hidden="true" style="width: 100%; height: 100%; object-fit: cover; border-radius: 50%;" />`;const l=o.displayName?.trim()||o.email||o.username;n.title=l,n.setAttribute("aria-label",`Selected student: ${l}`),s.appendChild(n)}),a.hidden=!1,a.innerHTML="",a.appendChild(s)},h=t=>{if(!t)return"—";const e=new Date(t);return Number.isNaN(e.getTime())?t:e.toLocaleString()},K=(t,e)=>{const r=typeof e=="string"?e.trim():"";if(r)return r;const a=t.split("/").pop()||t,s=decodeURIComponent(a);return s.replace(/\.pdf$/i,"").trim()||s},Q=()=>`
