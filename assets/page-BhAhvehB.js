import{d as Je,u as ct,v as lt,b as ut,m as ht,e as gt,n as mt,k as pt,p as vt,q as ft,w as wt,ae as yt,af as bt,ag as St,W as Tt,ah as Mt,ai as Ct,i as Et,l as It,aj as Lt,ak as $t,al as At,am as Se,an as Nt,c as kt,ao as Pt,ap as Te}from"./UserMenu-BSqryICX.js";import{a as xt,p as Rt,_ as Ut}from"./pdf.worker.min-Cbk1w7C7.js";import{b as Me,a as Ge,s as qt}from"./dialogs-1-2n60fz.js";import{r as Ye,s as Bt}from"./notePreviewCache-DZmGiybC.js";import{g as Xe,s as Dt}from"./authSession-TLN-xjT2.js";import{T as Ft}from"./trash-2-C9LfIeCh.js";import{A as Ht}from"./arrow-up-right-D218lQ-g.js";const Ot=["svg",Je,[["path",{d:"M12.586 2.586A2 2 0 0 0 11.172 2H4a2 2 0 0 0-2 2v7.172a2 2 0 0 0 .586 1.414l8.704 8.704a2.426 2.426 0 0 0 3.42 0l6.58-6.58a2.426 2.426 0 0 0 0-3.42z"}],["circle",{cx:"7.5",cy:"7.5",r:".5",fill:"currentColor"}]]];const _t=["svg",Je,[["path",{d:"M16 21v-2a4 4 0 0 0-4-4H6a4 4 0 0 0-4 4v2"}],["circle",{cx:"9",cy:"7",r:"4"}],["path",{d:"M22 21v-2a4 4 0 0 0-3-3.87"}],["path",{d:"M16 3.13a4 4 0 0 1 0 7.75"}]]],Ze="dwmt-notes-sort",Wt=220;Ut.workerSrc=Rt;const Kt=()=>`
...
`,me=o=>{if(!o)return"—";const d=new Date(o);return Number.isNaN(d.getTime())?o:d.toLocaleString()},i=(o,d,l)=>{if(!d){o.hidden=!0,o.textContent="",o.setAttribute("data-tone","");return}o.hidden=!1,o.textContent=d,o.setAttribute("data-tone",l)},Z=(o,d)=>{const u=(o instanceof Error?o.message:d).replace(/^(GET|POST|PATCH|DELETE)\s+\/[^\s]+\s+failed\s+\(\d+\):\s*/i,"");return/only the note owner/i.test(u)?"You don't have permission to change this note.":/authenticated user required/i.test(u)?"Please sign in again and retry.":u||d},Vt=o=>{try{localStorage.setItem(Ze,o)}catch{}},zt=()=>{try{const o=localStorage.getItem(Ze);if(o==="updated-desc"||o==="created-desc"||o==="created-asc"||o==="title-asc")return o}catch{}return"updated-desc"},Ce=o=>{const d=new URL("/whiteboard/",window.location.origin);return d.searchParams.set("openPdfKey",o),d.toString()},jt=o=>{const d=o.trim();if(!d)throw new Error("VITE_HTTP_API_ENDPOINT is empty");return(/^https?:\/\//i.test(d)?d:`https://${d}`).replace(/\/$/,"")},Gt=jt("https://6a6bgkrr3l.execute-api.af-south-1.amazonaws.com"),Yt=async o=>{const l=(await Xe())?.getIdToken().getJwtToken();if(!l)throw new Error("Missing session token for note preview");const u=await fetch(`${Gt}/notes/${encodeURIComponent(o)}/snapshot`,{headers:{Authorization:`Bearer ${l}`}}),y=await u.json();if(!u.ok||typeof y.url!="string")throw new Error(typeof y.error=="string"?y.error:`Failed to fetch note snapshot (${u.status})`);return y.url},Jt=async o=>{const l=await xt({url:o}).promise;let u=null;try{u=await l.getPage(1);const y=u.getViewport({scale:1}),Q=Wt/Math.max(1,y.width),F=u.getViewport({scale:Q}),L=document.createElement("canvas"),ee=L.getContext("2d");if(!ee)throw new Error("Canvas 2D context unavailable");return L.width=Math.max(1,Math.floor(F.width)),L.height=Math.max(1,Math.floor(F.height)),await u.render({canvasContext:ee,viewport:F}).promise,L.toDataURL("image/webp",.72)}finally{u?.cleanup(),await l.destroy()}},Ie="promotionPackage",Xt=()=>{const d=new URLSearchParams(window.location.search).get(Ie);return d?.trim()?d.trim():null},Ee=()=>{const o=new URL(window.location.href);o.searchParams.delete(Ie),window.history.replaceState({},"",o.toString())},Zt=async o=>{const d=await fetch(o,{cache:"no-store"});if(!d.ok)throw new Error(`Failed to load promotion package (${d.status})`);const l=await d.json();if(l.kind!=="note"||typeof l.promotionKey!="string"||typeof l.title!="string"||typeof l.pageCount!="number"||!Array.isArray(l.tagNames)||typeof l.snapshotUrl!="string")throw new Error("Promotion package was incomplete");return l},ia=async()=>{const o=document.querySelector("#app");if(!o)throw new Error("Missing #app root");const d=ct();if(d!=="tutor"&&d!=="student"){window.location.href="/whiteboard/";return}const l=lt().map(e=>e.trim().toLowerCase()),u=l.includes("admin"),y=l.includes("mailbox");o.innerHTML=Kt(),o.appendChild(ut()),ht(),gt();const Q=o.querySelector("#notesAppBarContainer");if(!Q)throw new Error("Missing notes app bar container");const F=mt();let L=0;if(y)try{L=await pt()}catch(e){console.warn("Failed to load inbox unread count",e)}const ee=vt({currentApp:"notes",onAppChange:e=>{if(e==="whiteboard"){window.location.href="/whiteboard/";return}if(e==="activity"){window.location.href="/activity/";return}if(e==="inbox"){window.location.href="/mailbox/";return}if(e==="worksheet-builder"){window.location.href="/worksheet-builder/";return}if(e==="issues"){window.location.href="/issues/";return}if(e==="user-management"){window.location.href="/user-management/";return}e==="profile"&&(window.location.href="/profile/")},rightContent:F,userRole:d,isAdmin:u,hasMailboxAccess:y,unreadInboxCount:L});Q.appendChild(ee),await ft({root:o,profileHref:"/profile/",signOutHref:"/auth",hideSelectStudent:!0,labelMode:"display-name-or-email",onSignOutClick:async()=>{await Dt(),window.location.href="/auth"}});const c=o.querySelector("#notesStatus"),te=o.querySelector("#notesTagFilters"),Le=o.querySelector("#notesSummary"),m=o.querySelector("#notesList"),v=o.querySelector("#notesContextMenu"),$e=o.querySelector("#notesRefreshBtn"),Ae=o.querySelector("#notesNewBtn"),Ne=o.querySelector("#notesManageTagsBtn"),ae=o.querySelector("#notesSortSelect"),H=o.querySelector("#notesTagModal"),ke=o.querySelector("#notesTagModalClose"),oe=o.querySelector("#notesTagModalList"),T=o.querySelector("#notesTagModalStatus"),ne=o.querySelector("#notesTagCreateForm"),pe=o.querySelector("#notesTagCreateInput"),O=o.querySelector("#noteAssignTagsModal"),Pe=o.querySelector("#noteAssignTagsModalClose"),x=o.querySelector("#noteAssignTagsModalStatus"),xe=o.querySelector("#noteAssignTagsModalSubtitle"),se=o.querySelector("#noteAssignTagsModalList"),Re=o.querySelector("#noteAssignTagsCancel"),Ue=o.querySelector("#noteAssignTagsSave"),_=o.querySelector("#noteShareModal"),qe=o.querySelector("#noteShareModalClose"),W=o.querySelector("#noteShareModalStatus"),Be=o.querySelector("#noteShareModalSubtitle"),R=o.querySelector("#noteShareSearchInput"),U=o.querySelector("#noteShareAccessSelect"),re=o.querySelector("#noteShareSearchHint"),$=o.querySelector("#noteShareSearchResults"),K=o.querySelector("#noteSharePeopleList"),De=o.querySelector("#noteShareCancel"),Fe=o.querySelector("#noteShareSave");if(!c||!te||!Le||!m||!v||!$e||!Ae||!Ne||!ae||!H||!ke||!oe||!T||!ne||!pe||!O||!Pe||!x||!xe||!se||!Re||!Ue||!_||!qe||!W||!Be||!R||!U||!re||!$||!K||!De||!Fe)throw new Error("Missing notes page controls");let f=[],M=[];const b=new Set;let V=null;const A=new Set;let q=null;const p=new Set,h=new Set;let z=[],j=!0,B="",ve=0,C=null;const G=new Map,fe=new Map;let D=zt();const E=u?wt():null;let we=null,ie=null,He=0;ae.value=D;const de=()=>{ie!==null&&(window.clearTimeout(ie),ie=null)},ce=()=>{v.hidden=!0,v.removeAttribute("style"),we=null},Oe=(e,a,t)=>{we=e,v.hidden=!1,v.style.left="0px",v.style.top="0px";const n=v.getBoundingClientRect(),s=Math.min(Math.max(12,a),Math.max(12,window.innerWidth-n.width-12)),r=Math.min(Math.max(12,t),Math.max(12,window.innerHeight-n.height-12));v.style.left=`${s}px`,v.style.top=`${r}px`},Qe=e=>{const a=[...e];return a.sort((t,n)=>D==="title-asc"?t.title.localeCompare(n.title):D==="created-asc"?(t.createdAt||"").localeCompare(n.createdAt||""):D==="created-desc"?(n.createdAt||"").localeCompare(t.createdAt||""):(n.updatedAt||"").localeCompare(t.updatedAt||"")),a},et=()=>{const e=f.filter(a=>{if(b.size===0)return!0;for(const t of b)if(!a.tagIds.includes(t))return!1;return!0});return Qe(e)},_e=()=>{const e=M.filter(t=>!t.archived||b.has(t.tagId));if(e.length===0){te.innerHTML='<div class="notes-empty-tags">No tags yet. Create one from “Manage tags”.</div>';return}te.innerHTML="";const a=document.createDocumentFragment();e.forEach(t=>{const n=document.createElement("button");n.type="button",n.className="notes-tag-chip",n.classList.toggle("is-active",b.has(t.tagId)),n.textContent=t.archived?`${t.name} (archived)`:t.name,n.addEventListener("click",()=>{b.has(t.tagId)?b.delete(t.tagId):b.add(t.tagId),_e(),be()}),a.appendChild(n)}),te.appendChild(a)},ye=(e,a)=>{const t=m.querySelector(`[data-note-preview-frame="${e}"]`);t&&(t.innerHTML=`<img class="notes-item-preview-image" src="${a}" alt="" loading="lazy" />`)},tt=async e=>{const a=e.noteId,t=G.get(a);if(t){ye(e.noteId,t);return}const n=Ye(e.noteId);if(n){G.set(a,n),ye(e.noteId,n);return}const s=fe.get(a);if(s){await s;return}const r=(async()=>{try{const g=await Yt(e.noteId),w=await Jt(g);G.set(a,w),Bt(e.noteId,w),ye(e.noteId,w)}catch{}finally{fe.delete(a)}})();fe.set(a,r),await r},at=async e=>{for(const a of e)await tt(a)},be=()=>{const e=et();if(Le.textContent=`${e.length} note${e.length===1?"":"s"} shown`,e.length===0){m.innerHTML='<div class="notes-empty">No notes match the current tag filter.</div>';return}const a=new Map(M.map(t=>[t.tagId,t.name]));m.innerHTML=e.map(t=>{const n=t.tagIds.map(P=>a.get(P)).filter(P=>!!P),s=t.noteId,r=G.get(s)??Ye(t.noteId);r&&G.set(s,r);const g=t.accessLevel==="owner",w=t.accessLevel==="owner",k=new Set([...t.sharedWithViewerEmails,...t.sharedWithEditorEmails]).size,ge=t.accessLevel==="owner"?k>0?`Shared with ${k} other${k===1?"":"s"}`:"Private":t.visibility==="shared"?"Shared with me":"Private";return`
        ...
        `}).join("")},le=()=>{O.hidden=!0,V=null,A.clear(),i(x,"","info")},Y=e=>e.trim().toLowerCase(),ue=()=>{const e=f.find(n=>n.noteId===q);if(!e){K.innerHTML='<div class="notes-empty-tags">Note not found.</div>';return}const a=[`
      ...
      `)}t.length===0&&a.push('<div class="notes-empty-tags">Private note. Add people to share it.</div>'),K.innerHTML=a.join("")},he=()=>{_.hidden=!0,q=null,p.clear(),h.clear(),z=[],j=!0,B="",R.value="",U.value="editor",re.textContent="",$.innerHTML="",C!==null&&(window.clearTimeout(C),C=null),i(W,"","info")},N=()=>{const e=f.find(s=>s.noteId===q);if(!e){re.textContent="",$.innerHTML="";return}const a=Y(e.ownerEmail||""),t=U.value==="viewer"?"viewer":"editor",n=z.filter(s=>{const r=Y(s.email);return!r||r===a?!1:!p.has(r)&&!h.has(r)});if(re.textContent=B,!j){$.innerHTML='<div class="notes-empty-tags">No eligible people are available for sharing yet.</div>';return}if(n.length===0){$.innerHTML=B?"":'<div class="notes-empty-tags">No matching members found.</div>';return}$.innerHTML=n.map(s=>{const r=s.displayName?.trim()||s.email,g=s.displayName?.trim()&&s.displayName.trim().toLowerCase()!==s.email?s.email:t==="editor"?"Can make changes":"Can view";return`
        ...
        `}).join("")},Ke=async e=>{const a=++ve;try{const t=await Pt(e);if(a!==ve)return;z=t.candidates,j=t.canShare,B=t.message||"",N()}catch(t){if(a!==ve)return;z=[],j=!0,B=t instanceof Error?t.message:"Failed to search members.",N()}},nt=e=>{const a=f.find(t=>t.noteId===e);if(!a){i(c,"Note not found.","error");return}q=e,p.clear(),h.clear(),a.sharedWithViewerEmails.forEach(t=>p.add(Y(t))),a.sharedWithEditorEmails.forEach(t=>h.add(Y(t))),Be.textContent=`People you add to “${a.title}” can view it or make changes.`,ue(),R.value="",U.value="editor",z=[],j=!0,B="Loading people…",N(),i(W,"","info"),_.hidden=!1,R.focus(),Ke("")},st=e=>{const a=f.find(t=>t.noteId===e);if(!a){i(c,"Note not found.","error");return}V=a.noteId,A.clear(),a.tagIds.forEach(t=>A.add(t)),xe.textContent=`Choose tags for “${a.title}”.`,ot(),i(x,"","info"),O.hidden=!1},Ve=()=>{if(M.length===0){oe.innerHTML='<div class="notes-empty-tags">No tags yet. Add your first tag above.</div>';return}oe.innerHTML=M.map(e=>`
