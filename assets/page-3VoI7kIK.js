import{u as ye,t as be,b as Ce,m as Se,e as $e,k as we,o as De,n as xe,p as qe,i as Ee,a0 as Le,a7 as ke,a3 as Re,a8 as de,a9 as Ae}from"./UserMenu-BoN4yhbF.js";import{g as Ie,s as Be}from"./authSession-BiVuXRSr.js";const fe=[{value:"open",label:"Open"},{value:"in-progress",label:"In progress"},{value:"require-clarification",label:"Needs clarification"},{value:"testing",label:"Testing"},{value:"tested",label:"Tested"},{value:"resolved",label:"Resolved"},{value:"duplicate",label:"Duplicate"},{value:"wont-fix",label:"Won't fix"}],Fe=()=>`
...
`,x=e=>{if(!e)return"Unknown";const a=new Date(e);return Number.isNaN(a.getTime())?e:a.toLocaleString()},pe=e=>fe.find(a=>a.value===e)?.label||e,me=e=>e.trim().toLowerCase(),Te=()=>{switch(Ee()){case"test":return"DEV";case"beta":return"STG";case"prod":return"PRD";case"local":return"DEV";default:return"DEV"}},m=(e,a,o)=>{if(!a){e.hidden=!0,e.textContent="",e.dataset.tone="";return}e.hidden=!1,e.textContent=a,e.dataset.tone=o},u=e=>e.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;"),d=e=>{if(typeof e=="string")return e.trim()||"—";if(typeof e=="number"||typeof e=="boolean")return String(e);if(!e)return"—";try{return JSON.stringify(e)}catch{return String(e)}},O=e=>e&&typeof e=="object"&&!Array.isArray(e)?e:{},V=e=>e?x(e):"Unknown time",j=(e,a)=>e.length>0?e.map(o=>`
            <div class="issues-telemetry-item">
              <pre>${u(o)}</pre>
            </div>
          `).join(""):`<div class="issues-empty-attachments">${u(a)}</div>`,Ue=e=>{const o=e.context&&typeof e.context=="object"?e.context:{};return[{label:"Issue ID",value:e.bugId},{label:"Reference",value:e.humanReference||e.bugId},{label:"Created",value:x(e.createdAt)},{label:"Updated",value:x(e.updatedAt)},{label:"Path",value:d(o.path)},{label:"URL",value:d(o.url)},{label:"Frontend",value:d(o.frontendDetails)},{label:"Backend",value:d(o.backendDetails)},{label:"Version",value:d(o.versionIndicator)},{label:"Reported env",value:d(e.reportedEnvironment)},{label:"Reported frontend rev",value:d(e.reportedFrontendCommit)},{label:"Reported backend rev",value:d(e.reportedBackendCommit)},{label:"Likely area",value:d(e.likelyArea)},{label:"Implementation status",value:d(e.implementationStatus)},{label:"Implementation summary",value:d(e.implementationSummary)},{label:"Viewport",value:d(o.viewport)},{label:"Device",value:d(o.deviceInfo)}]},Me=e=>{const a=O(e.context);return(Array.isArray(a.recentHttpFailures)?a.recentHttpFailures:[]).map(n=>{const v=typeof n.transport=="string"?n.transport:"?",g=typeof n.method=="string"?n.method:"GET",f=typeof n.url=="string"?n.url:"(unknown)",y=typeof n.status=="number"&&Number.isFinite(n.status)?` -> ${n.status}`:"",c=typeof n.error=="string"&&n.error.trim()?` (${n.error.trim()})`:"";return`${V(typeof n.ts=="string"?n.ts:void 0)} · ${v.toUpperCase()} ${g.toUpperCase()} ${f}${y}${c}`})},He=e=>{const a=O(e.context);return(Array.isArray(a.recentConsoleLogs)?a.recentConsoleLogs:[]).map(n=>{const v=typeof n.level=="string"?n.level.toUpperCase():"LOG",g=typeof n.message=="string"?n.message:"",f=typeof n.count=="number"&&Number.isFinite(n.count)?n.count:1,y=f>1?` (x${f})`:"";return`${V(typeof n.ts=="string"?n.ts:void 0)} · ${v}${y}
${g}`.trim()})},Ne=e=>{const a=O(e.context);return(Array.isArray(a.recentUiEvents)?a.recentUiEvents:[]).map(n=>{const v=typeof n.type=="string"?n.type:"event",g=typeof n.target=="string"?n.target:"unknown",f=typeof n.detail=="string"&&n.detail.trim()?` · ${n.detail.trim()}`:"";return`${V(typeof n.ts=="string"?n.ts:void 0)} · ${v} · ${g}${f}`})},Qe=e=>{const a=e.kind==="video",o=e.filename||"attachment";return`
    <article class="issues-attachment-card">
      <div class="issues-attachment-preview">${a?`<video controls preload="metadata" src="${e.url}"></video>`:`<img src="${e.url}" alt="${u(o)}" loading="lazy" />`}</div>
  ...
  `},Ve=async()=>{const e=document.querySelector("#app");if(!e)throw new Error("Missing #app root");const a=ye().map(t=>t.trim().toLowerCase()),o=a.includes("admin");if(!o){window.location.href="/whiteboard";return}const n=be(),v=a.includes("mailbox");e.innerHTML=Fe(),e.appendChild(Ce()),Se(),$e();const g=e.querySelector("#issuesAppBarContainer"),f=e.querySelector("#issuesEnvironmentLabel"),y=e.querySelector("#issuesRefreshBtn"),c=e.querySelector("#issuesListStatus"),G=e.querySelector("#issuesListSummary"),E=e.querySelector("#issuesList"),k=e.querySelector("#issuesSearchInput"),R=e.querySelector("#issuesStatusFilterChips"),A=e.querySelector("#issuesDetailEmpty"),I=e.querySelector("#issuesDetailCard"),P=e.querySelector("#issuesDetailMeta"),z=e.querySelector("#issuesDetailTitle"),B=e.querySelector("#issuesDetailStatusBadge"),_=e.querySelector("#issuesDetailReporter"),W=e.querySelector("#issuesDetailDescription"),J=e.querySelector("#issuesDetailClarification"),K=e.querySelector("#issuesDetailClarificationQuestion"),F=e.querySelector("#issuesDetailClarificationResponse"),X=e.querySelector("#issuesDetailAttachmentCount"),Y=e.querySelector("#issuesDetailAttachments"),Z=e.querySelector("#issuesDetailContext"),ee=e.querySelector("#issuesDetailHttpFailureCount"),te=e.querySelector("#issuesDetailHttpFailures"),se=e.querySelector("#issuesDetailConsoleLogCount"),ie=e.querySelector("#issuesDetailConsoleLogs"),ne=e.querySelector("#issuesDetailUiEventCount"),ae=e.querySelector("#issuesDetailUiEvents"),T=e.querySelector("#issuesDetailStatusSelect"),U=e.querySelector("#issuesDetailStatusNote"),w=e.querySelector("#issuesRetryAutomationBtn"),D=e.querySelector("#issuesSaveBtn");if(!g||!f||!y||!c||!G||!E||!k||!R||!A||!I||!P||!z||!B||!_||!W||!J||!K||!F||!X||!Y||!Z||!ee||!te||!se||!ie||!ne||!ae||!T||!U||!w||!D)throw new Error("Issues page failed to mount");f.textContent=Te();let oe=0;if(v)try{oe=await we()}catch(t){console.warn("Failed to load unread inbox count for issues page",t)}const he=De({currentApp:"issues",onAppChange:t=>{if(t==="whiteboard"){window.location.href="/whiteboard/";return}if(t==="activity"){window.location.href="/activity/";return}if(t==="inbox"){window.location.href="/mailbox/";return}if(t==="worksheet-builder"){window.location.href="/worksheet-builder/";return}if(t==="notes"){window.location.href="/notes/";return}if(t==="user-management"){window.location.href="/user-management/";return}t==="profile"&&(window.location.href="/profile/")},userRole:n,isAdmin:o,hasMailboxAccess:v,unreadInboxCount:oe,rightContent:xe()});g.appendChild(he),await qe({root:e,profileHref:"/profile/",signOutHref:"/auth",hideSelectStudent:!0,labelMode:"display-name-or-email",onSignOutClick:()=>{Be(),window.location.href="/auth"}});let h=[],r="",i=null;const S={query:"",status:"open"},M=()=>{const t=me(S.query);return h.filter(s=>re(s,S.status)?t?[s.summary,s.description,s.reporterEmail||"",s.humanReference||""].join(" ").toLowerCase().includes(t):!0:!1)},ve=t=>{const s=me(S.query);return s?[t.summary,t.description,t.reporterEmail||"",t.humanReference||""].join(" ").toLowerCase().includes(s):!0},re=(t,s)=>s==="all"?!0:s==="open"?t.status==="open":s==="in-progress"?t.status==="in-progress":s==="require-clarification"?t.status==="require-clarification":s==="testing-bucket"?t.status==="testing"||t.status==="tested":s==="resolved"?t.status==="resolved":s==="closed-other"?t.status==="duplicate"||t.status==="wont-fix":!1,ge=()=>{const t=h.filter(ve);R.querySelectorAll(".issues-filter-chip").forEach(s=>{const l=s.dataset.filterValue||"all",p=t.filter(C=>re(C,l)).length;s.classList.toggle("is-active",S.status===l),s.querySelector(".issues-filter-chip-count").textContent=String(p)})},b=()=>{const t=M();if(ge(),G.textContent=`${t.length} issue${t.length===1?"":"s"} shown`,t.length===0){E.innerHTML='<div class="issues-empty-list">No issues match the current filters.</div>';return}E.innerHTML=t.map(s=>{const l=s.bugId===r?" is-active":"",p=s.reporterEmail?`<span class="issues-list-item-reporter">${u(s.reporterEmail)}</span>`:"",C=s.implementationStatus?`<span>${u(s.implementationStatus)}</span>`:"",q=s.reportedEnvironment?`<span>${u(String(s.reportedEnvironment).toUpperCase())}</span>`:"";return`
